...
import { BrandFacebook, BrandInstagram, BrandLinkedin, BrandYoutube, MapPin } from "tabler-icons-react";
import "../App.css"
import {
  Button,
  Divider,
    ...
    <div className=" bg-[#222928] p-0 footer">
      ...
      <section className="bg-[url('/images/footer-bg.svg')] px-[40px] md:px-[100px]">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center py-4">
            <div className="text-[#949B95]">Copyright © 2023 initTheme. All rights reserved.</div>
